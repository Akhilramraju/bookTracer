...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.getOldBookByid = function (id) {
        return this.http.get("a/api/books/" + id);
    };
...
var DashboardComponent = /** @class */ (function () {
    ...
    DashboardComponent.prototype.ngOnInit = function () {
        ...
        this.dataService.getAllBooks()
            .subscribe(function (data) { return _this.allBooks = data; }, function (err) { return console.log(err); }, function () { return console.log('Got the required books using observer '); });
...
module.exports = __webpack_require__(/*! C:\Users\vasud\Downloads\angular-http-communication\02\demos\demos\Before\booktracker\src\main.ts */"./src/main.ts");
